...
#import "HPMKAppDelegate.h"
#import "HPMKBaseViewController.h"

@implementation HPMKAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]] ;
    HPMKBaseViewController *controller = [[HPMKBaseViewController alloc] initWithNibName:NSStringFromClass([HPMKBaseViewController class]) bundle:nil];
